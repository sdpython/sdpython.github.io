...
.. "auto_examples/plot_numpy_tricks.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_plot_numpy_tricks.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_numpy_tricks.py:
...
.. _sphx_glr_download_auto_examples_plot_numpy_tricks.py:
