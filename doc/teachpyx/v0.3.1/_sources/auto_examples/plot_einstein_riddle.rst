...
.. "auto_examples/plot_einstein_riddle.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_plot_einstein_riddle.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_einstein_riddle.py:
...
.. _sphx_glr_download_auto_examples_plot_einstein_riddle.py:
