...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [GraphBuilderPatternOptimization.optimize] applies 48 matches, 37*CastPattern, 4*ReshapeReshapePattern, 7*TransposeTransposePattern - time=0.009 | max_time=LeakyReluPattern:0.002
    ...
    [GraphBuilderPatternOptimization.optimize] applies 28 matches, 3*MulMulMulScalarPattern, 3*ReduceReshapePattern, 2*Reshape2Of3Pattern, 1*ReshapeReshapeBinaryPattern, 2*MatMulReshape2Of3Pattern, 2*RotaryConcatPartPattern, 1*Sub1MulPattern, 14*TransposeMatMulPattern - time=0.009 | max_time=Sub1MulPattern:0.002
    [GraphBuilderPatternOptimization.optimize] iteration 3: 131 nodes, priority=1
    [GraphBuilderPatternOptimization.optimize] applies 12 matches, 3*ExpandBroadcastPattern, 1*ReshapeReshapeBinaryPattern, 2*MatMulAddPattern, 2*MatMulReshape2Of3Pattern, 2*SlicesSplitPattern, 2*TransposeReshapeMatMulPattern - time=0.007 | max_time=Reshape2Of3Pattern:0.000
    ...
    [GraphBuilderPatternOptimization.optimize] applies 1 matches, [0]=MatchResult: MatMulAddPattern replaces ['Gemm', 'Add'] - time=0.004 | max_time=SwitchOrderBinaryPattern:0.000
    [GraphBuilderPatternOptimization.optimize] iteration 6: 120 nodes, priority=1
    [GraphBuilderPatternOptimization.optimize] done after 7 iterations with 120 nodes in 0.233
    [GraphBuilder.optimize] done with 117 nodes in 0.240
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    pattern                                                                                     
    apply_CastPattern                0.004173     37       37          0           36         37
    apply_ExpandBroadcastPattern     0.000313      3        6          3            2          3
    apply_MatMulAddPattern           0.000488      5        8          5            5          4
    apply_MatMulReshape2Of3Pattern   0.001795     10       12          3           10          4
    apply_MulMulMulScalarPattern     0.001517      6        9          2            2          3
    ...                                   ...    ...      ...        ...          ...        ...
    match_UnsqueezeEqualPattern      0.000451      0        0          6           28          0
    match_UnsqueezeUnsqueezePattern  0.000699      0        0          6           48          0
    pattern_optimization             0.234278      0       94          0            0          0
    remove_identity_nodes            0.003342     44       88          2            0          0
    remove_unused                    0.001574      0        3          0            0          0
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [GraphBuilderPatternOptimization.optimize] done after 1 iterations with 117 nodes in 0.003
        STAT build_graph_for_pattern +0 -0 #it=1 maxmatch=0 i=0 - time=0.0005777860005764524
        STAT check_pattern_00 +0 -0 #it=1 maxmatch=0 i=0 - time=0.00027761099954659585
        STAT check_pattern_B0 +0 -0 #it=1 maxmatch=0 i=0 - time=0.00024427099924650975
        STAT match_SwitchOrderBinaryPattern +0 -0 #it=1 maxmatch=0 i=0 - time=0.0009608149994164705
        STAT remove_identity_nodes +0 -0 #it=1 maxmatch=0 i=0 - time=0.00047053500020410866
    ...
    [GraphBuilder.optimize] done with 117 nodes in 0.013
