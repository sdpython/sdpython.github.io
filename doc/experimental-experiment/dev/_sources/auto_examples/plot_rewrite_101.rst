...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [GraphBuilder-NBC.optimize] start with 3 nodes
    [GraphBuilder-NBC.optimize] #patterns=1
    [GraphBuilderPatternOptimization-NBC.optimize] start with 3 nodes, 0 initializers, 1 patterns, priorities=[0], max_iter=10
    [GraphBuilderPatternOptimization-NBC.optimize] iteration 0: 3 nodes, priority=0
    [GraphBuilderPatternOptimization-NBC.optimize] applies 1 matches, [0]=MatchResult: MulMulSigmoidPattern replaces ['Sigmoid', 'Mul', 'Mul'] - time=0.001 | max_time=MulMulSigmoidPattern:0.001
    [GraphBuilderPatternOptimization-NBC.optimize] iteration 1: 1 nodes, priority=0
    [GraphBuilderPatternOptimization-NBC.optimize] stops current_priority_index=1, priorities=[0]
    [GraphBuilderPatternOptimization-NBC.optimize] done after 2 iterations with 1 nodes in 0.002
    [GraphBuilder-NBC.optimize] done with 1 nodes in 0.003
    opset: domain='' version=18
