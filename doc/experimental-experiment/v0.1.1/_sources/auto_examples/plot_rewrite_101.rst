...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [GraphBuilder-RRC.optimize] start with 3 nodes
    [GraphBuilder-RRC.optimize] #patterns=1
    [GraphBuilderPatternOptimization-RRC.optimize] start with 3 nodes, 0 initializers, 1 patterns, priorities=[0], max_iter=10
    [GraphBuilderPatternOptimization-RRC.optimize] iteration 0: 3 nodes, priority=0
    [GraphBuilderPatternOptimization-RRC.optimize] applies 1 matches, [0]=MatchResult: MulMulSigmoidPattern replaces ['Sigmoid', 'Mul', 'Mul'] - time=0.001 | max_time=MulMulSigmoidPattern:0.001
    [GraphBuilderPatternOptimization-RRC.optimize] iteration 1: 1 nodes, priority=0
    [GraphBuilderPatternOptimization-RRC.optimize] stops current_priority_index=1, priorities=[0]
    [GraphBuilderPatternOptimization-RRC.optimize] done after 2 iterations with 1 nodes in 0.003
    [GraphBuilder-RRC.optimize] done with 1 nodes in 0.003
    opset: domain='' version=18
