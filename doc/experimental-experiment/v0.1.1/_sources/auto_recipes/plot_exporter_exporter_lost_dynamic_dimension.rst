...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    graph():
        ...
        %stack : [num_users=2] = call_function[target=torch.ops.aten.stack.default](args = ([%scalar_tensor],), kwargs = {})
        %_assert_tensor_metadata_default : [num_users=0] = call_function[target=torch.ops.aten._assert_tensor_metadata.default](args = (%stack,), kwargs = {dtype: torch.int64, device: cpu, layout: torch.strided})
