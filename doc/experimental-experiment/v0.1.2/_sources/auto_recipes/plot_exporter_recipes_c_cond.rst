...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensor([[-1.4999]], grad_fn=<MulBackward0>)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    init: name='GemmTransposePattern--p_mlp_1_weight::T10' type=float32 shape=(1, 2) -- array([-0.42364165, -0.68871677], dtype=float32)-- GraphBuilder.constant_folding.from/fold(init7_s2_1_-1,p_mlp_1_weight::T10)##p_mlp_1_weight::T10/GraphBuilder.constant_folding.from/fold(p_mlp_1_weight)##p_mlp_1_weight/DynamoInterpret.placeholder.1/P(mlp.1.weight)##init7_s2_1_-1/TransposeEqualReshapePattern.apply.new_shape
    init: name='mlp.0.bias' type=float32 shape=(2,) -- array([-0.55887866, -0.00949558], dtype=float32)-- DynamoInterpret.placeholder.1/P(mlp.0.bias)
    init: name='mlp.1.bias' type=float32 shape=(1,) -- array([-0.67199636], dtype=float32)-- DynamoInterpret.placeholder.1/P(mlp.1.bias)
