...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensor([[0.5903, 0.2513, 0.7285]], grad_fn=<ReluBackward0>)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    init: name='neuron.linear.bias' type=float32 shape=(3,) -- array([-0.3975952 ,  0.3577706 , -0.19402753], dtype=float32)-- DynamoInterpret.placeholder.1/P(neuron.linear.bias)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    input: name='x' type=dtype('float32') shape=[1, 5]
    init: name='bias_cst2init' type=float32 shape=(3,) -- array([-0.3975952 ,  0.3577706 , -0.19402753], dtype=float32)-- GraphBuilderPatternOptimization.make_initializer.0
