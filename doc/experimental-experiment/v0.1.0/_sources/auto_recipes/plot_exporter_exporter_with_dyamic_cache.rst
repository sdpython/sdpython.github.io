...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Exported graphs inputs can only contain the following supported types: [<class 'torch.Tensor'>, <class 'torch.SymInt'>, <class 'torch.SymFloat'>, <class 'torch.SymBool'>, <class 'torch.ScriptObject'>, <class 'int'>, <class 'torch.finfo'>, <class 'triton.language.core.dtype'>, <class 'NoneType'>, <class 'torch.nn.attention._SDPBackend'>, <class 'float'>, <class 'bool'>, <class 'torch.layout'>, <class 'torch.device'>, <class 'code'>, <class 'complex'>, <class 'ellipsis'>, <class 'str'>, <class 'torch._C._CudaDeviceProperties'>, <class 'torch.memory_format'>, <class 'torch.dtype'>, <class 'bytes'>, <class 'NotImplementedType'>, <class 'torch.iinfo'>]. 
