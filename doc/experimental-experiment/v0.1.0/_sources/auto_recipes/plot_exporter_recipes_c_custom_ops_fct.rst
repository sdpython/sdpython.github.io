...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    --DEBUG--
    [GraphBuilder-OZG] Message starts, there are 0 initializers, 0 nodes, 1 inputs, 1 outputs.
    --PARAMETERS--
    dynamic_examples=
    --SHAPE--
    dynamic_examples=
    ...
    graph():
        ...
        %view_as : [num_users=1] = call_function[target=torch.ops.aten.view_as.default](args = (%x, %x), kwargs = {})
        %sin : [num_users=1] = call_function[target=torch.ops.aten.sin.default](args = (%view_as,), kwargs = {})
        %to : [num_users=1] = call_function[target=torch.ops.aten.to.device](args = (%sin, cpu, torch.float32), kwargs = {})
        return (to,)
    -- process.progress --
    node 1/5 target=aten.view_as.default
    --
    [GraphBuilder-OZG.make_tensor_input] x[1:1x3]
    [GraphBuilder-OZG] Message completed, there are 0 initializers, 0 nodes, 1 inputs, 1 outputs.
