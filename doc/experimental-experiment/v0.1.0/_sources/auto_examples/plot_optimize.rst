...
.. "auto_examples/plot_optimize.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_plot_optimize.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_optimize.py:
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_optimize_001.png
   :alt: plot optimize
   :srcset: /auto_examples/images/sphx_glr_plot_optimize_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Gemm(view_22, input32, transA=0, transB=1) -> mm_9
      Reshape(mm_9, init7_s3_2_1024_10242) -> view_23
        Mul(view_23, input28) -> _onx_mul09
          Reshape(_onx_mul09, init7_s2_2048_10242) -> view_24
          ...
          Mul(add_10, input1) -> _onx_mul014
            Mul(_onx_mul014, input22) -> _onx_mul016
              ReduceSum(_onx_mul016, init7_s1_22, keepdims=1) -> sum_4
                Mul(sum_4, init1_s_5) -> _onx_mul018
          Mul(add_10, input24) -> _onx_mul015
            ReduceSum(_onx_mul015, init7_s2_0_12, keepdims=1) -> sum_3
              Reshape(sum_3, init7_s1_10242) -> output_1
          ...
          Mul(add_20, input0) -> _onx_mul028
            Mul(_onx_mul028, input4) -> _onx_mul030
              ReduceSum(_onx_mul030, init7_s1_23, keepdims=1) -> sum_6
                Mul(sum_6, init1_s_9) -> _onx_mul032
          Mul(add_20, input6) -> _onx_mul029
            ReduceSum(_onx_mul029, init7_s2_0_13, keepdims=1) -> sum_5
              Reshape(sum_5, init7_s1_10243) -> output_0
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_optimize_002.png
   :alt: plot optimize
   :srcset: /auto_examples/images/sphx_glr_plot_optimize_002.png
   :class: sphx-glr-single-img
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_optimize.ipynb <plot_optimize.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_optimize.py <plot_optimize.py>`
