...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [get_untrained_model_with_inputs] use fct=<function get_inputs at 0x7ff5b54c8d60>
    model size: 410532864
    number of weights: 102633216
    fields: {'model_kwargs', 'n_weights', 'input_kwargs', 'model', 'configuration', 'inputs', 'size', 'task', 'dynamic_shapes'}
