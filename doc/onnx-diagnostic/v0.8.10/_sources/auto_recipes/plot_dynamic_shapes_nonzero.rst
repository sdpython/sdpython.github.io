 ...
 .. code-block:: none
    ...
    ExportedProgram:
        class GraphModule(torch.nn.Module):
            def forward(self, c_lifted_tensor_0: "i64[0]", c_lifted_tensor_1: "i64[1]", c_lifted_tensor_2: "i64[]", c_lifted_tensor_3: "i64[]", x: "f32[s77, s27]", y: "f32[s17]"):
                # No stacktrace found for following nodes
                sym_size_int_4: "Sym(s27)" = torch.ops.aten.sym_size.int(x, 1);  x = None
                sym_size_int_5: "Sym(s17)" = torch.ops.aten.sym_size.int(y, 0);  y = None
                ...
                scalar_tensor: "i64[]" = torch.ops.aten.scalar_tensor.default(sym_size_int_4, dtype = torch.int64, device = device(type='cpu'), pin_memory = False)
                ...
                arange: "i64[s27]" = torch.ops.aten.arange.start(0, sym_size_int_4, device = device(type='cpu'), pin_memory = False)
                unsqueeze: "i64[s27, 1]" = torch.ops.aten.unsqueeze.default(arange, -1);  arange = None
                lt: "b8[s27, 1]" = torch.ops.aten.lt.Tensor(unsqueeze, cat_1)
                ge: "b8[s27, 1]" = torch.ops.aten.ge.Tensor(unsqueeze, cat);  unsqueeze = None
                and_1: "b8[s27, 1]" = torch.ops.aten.__and__.Tensor(lt, ge);  lt = ge = None
                nonzero: "i64[s27, 2]" = torch.ops.aten.nonzero.default(and_1);  and_1 = None
            
                # No stacktrace found for following nodes
                sym_size_int_6: "Sym(s27)" = torch.ops.aten.sym_size.int(nonzero, 0)
                sym_constrain_range_for_size_default = torch.ops.aten.sym_constrain_range_for_size.default(sym_size_int_6);  sym_constrain_range_for_size_default = None
            
                # File: /home/xadupre/github/onnx-diagnostic/_doc/recipes/plot_dynamic_shapes_nonzero.py:41 in forward, code: return self.adaptive_enc_mask(
                ge_2: "Sym(s27 >= 2)" = sym_size_int_6 >= 2
                ...
                # No stacktrace found for following nodes
                eq: "Sym(True)" = sym_size_int_4 == sym_size_int_6;  sym_size_int_6 = None
                _assert_scalar_default_1 = torch.ops.aten._assert_scalar.default(eq, "Runtime assertion failed for expression Eq(s27, u0) on node 'eq'");  eq = _assert_scalar_default_1 = None
            
                # File: /home/xadupre/github/onnx-diagnostic/_doc/recipes/plot_dynamic_shapes_nonzero.py:41 in forward, code: return self.adaptive_enc_mask(
                select: "i64[s27]" = torch.ops.aten.select.int(nonzero, 1, 1);  nonzero = None
                arange_1: "i64[s27]" = torch.ops.aten.arange.start(0, sym_size_int_4, device = device(type='cpu'), pin_memory = False)
                unsqueeze_1: "i64[1, s27]" = torch.ops.aten.unsqueeze.default(arange_1, 0);  arange_1 = None
                expand: "i64[s27, s27]" = torch.ops.aten.expand.default(unsqueeze_1, [sym_size_int_4, -1]);  unsqueeze_1 = sym_size_int_4 = None
                sub: "i64[s27]" = torch.ops.aten.sub.Tensor(select, sym_size_int_5);  sym_size_int_5 = None
                lt_1: "b8[s27]" = torch.ops.aten.lt.Scalar(sub, 0)
                lift_fresh_copy_2: "i64[]" = torch.ops.aten.lift_fresh_copy.default(c_lifted_tensor_2);  c_lifted_tensor_2 = None
                index_put_: "i64[s27]" = torch.ops.aten.index_put_.default(sub, [lt_1], lift_fresh_copy_2);  sub = lt_1 = lift_fresh_copy_2 = None
                index: "i64[s27]" = torch.ops.aten.index.Tensor(cat, [index_put_]);  cat = index_put_ = None
                unsqueeze_2: "i64[s27, 1]" = torch.ops.aten.unsqueeze.default(index, -1);  index = None
                ge_1: "b8[s27, s27]" = torch.ops.aten.ge.Tensor(expand, unsqueeze_2);  unsqueeze_2 = None
                add: "i64[s27]" = torch.ops.aten.add.Tensor(select, 0);  select = None
                gt: "b8[s27]" = torch.ops.aten.gt.Scalar(add, 0)
                lift_fresh_copy_3: "i64[]" = torch.ops.aten.lift_fresh_copy.default(c_lifted_tensor_3);  c_lifted_tensor_3 = None
                index_put__1: "i64[s27]" = torch.ops.aten.index_put_.default(add, [gt], lift_fresh_copy_3);  add = gt = lift_fresh_copy_3 = None
                index_1: "i64[s27]" = torch.ops.aten.index.Tensor(cat_1, [index_put__1]);  cat_1 = index_put__1 = None
                unsqueeze_3: "i64[s27, 1]" = torch.ops.aten.unsqueeze.default(index_1, -1);  index_1 = None
                lt_2: "b8[s27, s27]" = torch.ops.aten.lt.Tensor(expand, unsqueeze_3);  expand = unsqueeze_3 = None
                and_2: "b8[s27, s27]" = torch.ops.aten.__and__.Tensor(ge_1, lt_2);  ge_1 = lt_2 = None
                return (and_2,)
