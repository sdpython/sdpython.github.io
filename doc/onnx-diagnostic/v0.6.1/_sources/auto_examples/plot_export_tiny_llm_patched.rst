...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [torch_export_patches] torch.__version__='2.8.0.dev20250601+cu126'
        ...
        class GraphModule(torch.nn.Module):
            def forward(self, p_model_embed_tokens_weight: "f32[32000, 192]", p_model_layers_0_self_attn_q_proj_weight: "f32[192, 192]", p_model_layers_0_self_attn_k_proj_weight: "f32[96, 192]", p_model_layers_0_self_attn_v_proj_weight: "f32[96, 192]", p_model_layers_0_self_attn_o_proj_weight: "f32[192, 192]", p_model_layers_0_mlp_gate_proj_weight: "f32[1024, 192]", p_model_layers_0_mlp_up_proj_weight: "f32[1024, 192]", p_model_layers_0_mlp_down_proj_weight: "f32[192, 1024]", p_model_layers_0_input_layernorm_weight: "f32[192]", p_model_layers_0_post_attention_layernorm_weight: "f32[192]", p_model_norm_weight: "f32[192]", p_lm_head_weight: "f32[32000, 192]", b_model_rotary_emb_inv_freq: "f32[48]", input_ids: "i64[s41, s2]", attention_mask: "i64[s41, s10]", position_ids: "i64[s41, s2]", past_key_values_key_cache_0: "f32[s41, 1, s67, 96]", past_key_values_value_cache_0: "f32[s41, 1, s67, 96]"):
                ...
                embedding: "f32[s41, s2, 192]" = torch.ops.aten.embedding.default(p_model_embed_tokens_weight, input_ids);  p_model_embed_tokens_weight = input_ids = None
                 ...
                 # 
                eq_18: "Sym(True)" = sym_size_int_19 == sym_size_int_21;  sym_size_int_21 = None
                _assert_scalar_default = torch.ops.aten._assert_scalar.default(eq_18, "Runtime assertion failed for expression Eq(s41, s89) on node 'eq_18'");  eq_18 = _assert_scalar_default = None
                eq_19: "Sym(True)" = sym_size_int_19 == sym_size_int_23;  sym_size_int_23 = None
                _assert_scalar_default_1 = torch.ops.aten._assert_scalar.default(eq_19, "Runtime assertion failed for expression Eq(s41, s62) on node 'eq_19'");  eq_19 = _assert_scalar_default_1 = None
                ...
                add: "Sym(s2 + s67)" = sym_size_int_22 + sym_size_int_16
                ...
                arange: "i64[s2]" = torch.ops.aten.arange.start(sym_size_int_22, add, device = device(type='cpu'), pin_memory = False);  sym_size_int_22 = None
                ...
                to: "b8[s41, s10]" = torch.ops.aten.to.device(attention_mask, device(type='cpu'), torch.bool);  attention_mask = None
                ...
                arange_2: "i64[s41]" = torch.ops.aten.arange.default(sym_size_int_19, device = device(type='cpu'), pin_memory = False)
                arange_3: "i64[1]" = torch.ops.aten.arange.default(1, device = device(type='cpu'), pin_memory = False)
                reshape: "i64[s41, 1, 1, 1]" = torch.ops.aten.reshape.default(arange_2, [-1, 1, 1, 1]);  arange_2 = None
                ...
                expand: "i64[s41, 1, s2, s2 + s67]" = torch.ops.aten.expand.default(reshape, [sym_size_int_19, 1, sym_size_int_16, add]);  reshape = None
                expand_1: "i64[s41, 1, s2, s2 + s67]" = torch.ops.aten.expand.default(reshape_1, [sym_size_int_19, 1, sym_size_int_16, add]);  reshape_1 = expand_1 = None
                expand_2: "i64[s41, 1, s2, s2 + s67]" = torch.ops.aten.expand.default(reshape_2, [sym_size_int_19, 1, sym_size_int_16, add]);  reshape_2 = None
                expand_3: "i64[s41, 1, s2, s2 + s67]" = torch.ops.aten.expand.default(reshape_3, [sym_size_int_19, 1, sym_size_int_16, add]);  reshape_3 = None
                new_ones: "b8[]" = torch.ops.aten.new_ones.default(expand_2, [], dtype = torch.bool, pin_memory = False)
                le: "b8[s41, 1, s2, s2 + s67]" = torch.ops.aten.le.Tensor(expand_3, expand_2);  expand_2 = None
                and_1: "b8[s41, 1, s2, s2 + s67]" = torch.ops.aten.__and__.Tensor(new_ones, le);  new_ones = le = None
                ...
                index: "b8[s41, 1, s2, s2 + s67]" = torch.ops.aten.index.Tensor(to, [expand, expand_3]);  to = expand = expand_3 = None
            
                 # File: /home/xadupre/github/transformers/src/transformers/models/llama/modeling_llama.py:422 in forward, code: causal_mask = create_causal_mask(
                and_2: "b8[s41, 1, s2, s2 + s67]" = torch.ops.aten.__and__.Tensor(and_1, index);  and_1 = index = None
                ...
                view: "f32[s41, s2, 2, 96]" = torch.ops.aten.view.default(linear, [sym_size_int_19, sym_size_int_16, -1, 96]);  linear = None
                ...
                view_1: "f32[s41, s2, 1, 96]" = torch.ops.aten.view.default(linear_1, [sym_size_int_19, sym_size_int_16, -1, 96]);  linear_1 = None
                ...
                view_2: "f32[s41, s2, 1, 96]" = torch.ops.aten.view.default(linear_2, [sym_size_int_19, sym_size_int_16, -1, 96]);  linear_2 = None
                ...
                unsqueeze_3: "f32[s41, 1, s2, 96]" = torch.ops.aten.unsqueeze.default(to_6, 1);  to_6 = None
                unsqueeze_4: "f32[s41, 1, s2, 96]" = torch.ops.aten.unsqueeze.default(to_7, 1);  to_7 = None
                mul_4: "f32[s41, 2, s2, 96]" = torch.ops.aten.mul.Tensor(transpose_1, unsqueeze_3)
                slice_4: "f32[s41, 2, s2, 48]" = torch.ops.aten.slice.Tensor(transpose_1, 3, 0, 48)
                slice_5: "f32[s41, 2, s2, 48]" = torch.ops.aten.slice.Tensor(transpose_1, 3, 48, 9223372036854775807);  transpose_1 = None
                neg: "f32[s41, 2, s2, 48]" = torch.ops.aten.neg.default(slice_5);  slice_5 = None
                cat_1: "f32[s41, 2, s2, 96]" = torch.ops.aten.cat.default([neg, slice_4], -1);  neg = slice_4 = None
                mul_5: "f32[s41, 2, s2, 96]" = torch.ops.aten.mul.Tensor(cat_1, unsqueeze_4);  cat_1 = None
                add_4: "f32[s41, 2, s2, 96]" = torch.ops.aten.add.Tensor(mul_4, mul_5);  mul_4 = mul_5 = None
                mul_6: "f32[s41, 1, s2, 96]" = torch.ops.aten.mul.Tensor(transpose_2, unsqueeze_3);  unsqueeze_3 = None
                slice_6: "f32[s41, 1, s2, 48]" = torch.ops.aten.slice.Tensor(transpose_2, 3, 0, 48)
                slice_7: "f32[s41, 1, s2, 48]" = torch.ops.aten.slice.Tensor(transpose_2, 3, 48, 9223372036854775807);  transpose_2 = None
                neg_1: "f32[s41, 1, s2, 48]" = torch.ops.aten.neg.default(slice_7);  slice_7 = None
                cat_2: "f32[s41, 1, s2, 96]" = torch.ops.aten.cat.default([neg_1, slice_6], -1);  neg_1 = slice_6 = None
                mul_7: "f32[s41, 1, s2, 96]" = torch.ops.aten.mul.Tensor(cat_2, unsqueeze_4);  cat_2 = unsqueeze_4 = None
                ...
                slice_8: "f32[s41, 1, s2 + s67, 96]" = torch.ops.aten.slice.Tensor(cat_3, 0, 0, 9223372036854775807)
                slice_9: "f32[s41, 1, s2 + s67, 96]" = torch.ops.aten.slice.Tensor(slice_8, 1, 0, 9223372036854775807);  slice_8 = None
                unsqueeze_5: "f32[s41, 1, 1, s2 + s67, 96]" = torch.ops.aten.unsqueeze.default(slice_9, 2);  slice_9 = None
                slice_10: "f32[s41, 1, 1, s2 + s67, 96]" = torch.ops.aten.slice.Tensor(unsqueeze_5, 3, 0, 9223372036854775807);  unsqueeze_5 = None
                slice_11: "f32[s41, 1, 1, s2 + s67, 96]" = torch.ops.aten.slice.Tensor(slice_10, 4, 0, 9223372036854775807);  slice_10 = None
                expand_5: "f32[s41, 1, 2, s2 + s67, 96]" = torch.ops.aten.expand.default(slice_11, [sym_size_int_19, 1, 2, add, 96]);  slice_11 = None
                reshape_4: "f32[s41, 2, s2 + s67, 96]" = torch.ops.aten.reshape.default(expand_5, [sym_size_int_19, 2, add, 96]);  expand_5 = None
                slice_12: "f32[s41, 1, s2 + s67, 96]" = torch.ops.aten.slice.Tensor(cat_4, 0, 0, 9223372036854775807)
                slice_13: "f32[s41, 1, s2 + s67, 96]" = torch.ops.aten.slice.Tensor(slice_12, 1, 0, 9223372036854775807);  slice_12 = None
                unsqueeze_6: "f32[s41, 1, 1, s2 + s67, 96]" = torch.ops.aten.unsqueeze.default(slice_13, 2);  slice_13 = None
                slice_14: "f32[s41, 1, 1, s2 + s67, 96]" = torch.ops.aten.slice.Tensor(unsqueeze_6, 3, 0, 9223372036854775807);  unsqueeze_6 = None
                slice_15: "f32[s41, 1, 1, s2 + s67, 96]" = torch.ops.aten.slice.Tensor(slice_14, 4, 0, 9223372036854775807);  slice_14 = None
                expand_6: "f32[s41, 1, 2, s2 + s67, 96]" = torch.ops.aten.expand.default(slice_15, [sym_size_int_19, 1, 2, add, 96]);  slice_15 = None
                reshape_5: "f32[s41, 2, s2 + s67, 96]" = torch.ops.aten.reshape.default(expand_6, [sym_size_int_19, 2, add, 96]);  expand_6 = None
                slice_16: "b8[s41, 1, s2, s2 + s67]" = torch.ops.aten.slice.Tensor(and_2);  and_2 = None
                slice_17: "b8[s41, 1, s2, s2 + s67]" = torch.ops.aten.slice.Tensor(slice_16, 1);  slice_16 = None
                slice_18: "b8[s41, 1, s2, s2 + s67]" = torch.ops.aten.slice.Tensor(slice_17, 2);  slice_17 = None
                slice_19: "b8[s41, 1, s2, s2 + s67]" = torch.ops.aten.slice.Tensor(slice_18, 3, None, add);  slice_18 = add = None
                contiguous: "f32[s41, 2, s2, 96]" = torch.ops.aten.contiguous.default(add_4);  add_4 = None
                contiguous_1: "f32[s41, 2, s2 + s67, 96]" = torch.ops.aten.contiguous.default(reshape_4);  reshape_4 = None
                contiguous_2: "f32[s41, 2, s2 + s67, 96]" = torch.ops.aten.contiguous.default(reshape_5);  reshape_5 = None
                scaled_dot_product_attention: "f32[s41, 2, s2, 96]" = torch.ops.aten.scaled_dot_product_attention.default(contiguous, contiguous_1, contiguous_2, slice_19, scale = 0.10206207261596575);  contiguous = contiguous_1 = contiguous_2 = slice_19 = None
                ...
                reshape_6: "f32[s41, s2, 192]" = torch.ops.aten.reshape.default(contiguous_3, [sym_size_int_19, sym_size_int_16, -1]);  contiguous_3 = sym_size_int_19 = sym_size_int_16 = None
            
                 # File: /home/xadupre/vv/this312/lib/python3.12/site-packages/torch/nn/modules/linear.py:125 in forward, code: return F.linear(input, self.weight, self.bias)
                linear_3: "f32[s41, s2, 192]" = torch.ops.aten.linear.default(reshape_6, p_model_layers_0_self_attn_o_proj_weight);  reshape_6 = p_model_layers_0_self_attn_o_proj_weight = None
                ...
                mul_12: "f32[s41, s2, 192]" = torch.ops.aten.mul.Tensor(to_10, rsqrt_1);  rsqrt_1 = None
                ...
                to_11: "f32[s41, s2, 192]" = torch.ops.aten.to.dtype(mul_12, torch.float32);  mul_12 = None
                mul_13: "f32[s41, s2, 192]" = torch.ops.aten.mul.Tensor(p_model_layers_0_post_attention_layernorm_weight, to_11);  p_model_layers_0_post_attention_layernorm_weight = to_11 = None
            
                 # File: /home/xadupre/vv/this312/lib/python3.12/site-packages/torch/nn/modules/linear.py:125 in forward, code: return F.linear(input, self.weight, self.bias)
                linear_4: "f32[s41, s2, 1024]" = torch.ops.aten.linear.default(mul_13, p_model_layers_0_mlp_gate_proj_weight);  p_model_layers_0_mlp_gate_proj_weight = None
                ...
                silu: "f32[s41, s2, 1024]" = torch.ops.aten.silu.default(linear_4);  linear_4 = None
                 ...
                 # File: /home/xadupre/vv/this312/lib/python3.12/site-packages/torch/nn/modules/linear.py:125 in forward, code: return F.linear(input, self.weight, self.bias)
                linear_5: "f32[s41, s2, 1024]" = torch.ops.aten.linear.default(mul_13, p_model_layers_0_mlp_up_proj_weight);  mul_13 = p_model_layers_0_mlp_up_proj_weight = None
                ...
                mul_14: "f32[s41, s2, 1024]" = torch.ops.aten.mul.Tensor(silu, linear_5);  silu = linear_5 = None
            
                 # File: /home/xadupre/vv/this312/lib/python3.12/site-packages/torch/nn/modules/linear.py:125 in forward, code: return F.linear(input, self.weight, self.bias)
                linear_6: "f32[s41, s2, 192]" = torch.ops.aten.linear.default(mul_14, p_model_layers_0_mlp_down_proj_weight);  mul_14 = p_model_layers_0_mlp_down_proj_weight = None
                ...
                mul_15: "f32[s41, s2, 192]" = torch.ops.aten.mul.Tensor(to_12, rsqrt_2);  to_12 = rsqrt_2 = None
                ...
                to_13: "f32[s41, s2, 192]" = torch.ops.aten.to.dtype(mul_15, torch.float32);  mul_15 = None
                mul_16: "f32[s41, s2, 192]" = torch.ops.aten.mul.Tensor(p_model_norm_weight, to_13);  p_model_norm_weight = to_13 = None
                ...
                slice_20: "f32[s41, s2, 192]" = torch.ops.aten.slice.Tensor(mul_16);  mul_16 = None
                slice_21: "f32[s41, s2, 192]" = torch.ops.aten.slice.Tensor(slice_20, 1, 0);  slice_20 = None
                slice_22: "f32[s41, s2, 192]" = torch.ops.aten.slice.Tensor(slice_21, 2);  slice_21 = None
            
                 # File: /home/xadupre/vv/this312/lib/python3.12/site-packages/torch/nn/modules/linear.py:125 in forward, code: return F.linear(input, self.weight, self.bias)
                linear_7: "f32[s41, s2, 32000]" = torch.ops.aten.linear.default(slice_22, p_lm_head_weight);  slice_22 = p_lm_head_weight = None
                return (linear_7, cat_3, cat_4)
            
            class submod_1(torch.nn.Module):
                def forward(self, b_model_rotary_emb_inv_freq: "f32[48]", sym_size_int_19: "Sym(s41)", position_ids: "i64[s41, s2]"):
                    ...
                    expand_4: "f32[s41, 48, 1]" = torch.ops.aten.expand.default(to_1, [sym_size_int_19, -1, 1]);  to_1 = sym_size_int_19 = None
                    ...
                    to_2: "f32[s41, 48, 1]" = torch.ops.aten.to.dtype_layout(expand_4, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'));  expand_4 = None
                    ...
                    slice_2: "i64[s41, s2]" = torch.ops.aten.slice.Tensor(position_ids, 0, 0, 9223372036854775807);  position_ids = None
                    unsqueeze_2: "i64[s41, 1, s2]" = torch.ops.aten.unsqueeze.default(slice_2, 1);  slice_2 = None
                    slice_3: "i64[s41, 1, s2]" = torch.ops.aten.slice.Tensor(unsqueeze_2, 2, 0, 9223372036854775807);  unsqueeze_2 = None
                    ...
                    to_3: "f32[s41, 1, s2]" = torch.ops.aten.to.dtype(slice_3, torch.float32);  slice_3 = None
    ...
    Range constraints: {s41: VR[1, 1024], s2: VR[2, 4096], s10: VR[4, 8192], s67: VR[1, 4096]}
