...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    -- export shape: (T1s2x3,T1s2x5,T1s1x8)
    -- dynamic shapes: ({0:DYNAMIC,1:DYNAMIC},{0:DYNAMIC,1:DYNAMIC},{0:DYNAMIC,1:DYNAMIC})
    ERROR non-broadcasting semantics require s68 == Max(s17, s68), False, guard_or_false(a.shape[idx]==1)=False, a.stride()=(s32, 1), idx=0, a.shape=torch.Size([s68, s32]), shape=[Max(s17, s68), Max(s32, s27 + s94)], original_idx=0
