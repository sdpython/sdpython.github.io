...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [[0.      0.0625  0.0625  0.0625  0.0625  0.0625  0.0625 ]
     [0.0625  0.      0.03125 0.03125 0.03125 0.03125 0.     ]
     [0.0625  0.03125 0.      0.      0.      0.      0.03125]
     [0.0625  0.03125 0.      0.      0.      0.      0.03125]
     [0.0625  0.03125 0.      0.      0.      0.      0.03125]
     [0.0625  0.03125 0.      0.      0.      0.      0.03125]
     [0.0625  0.      0.03125 0.03125 0.03125 0.03125 0.     ]]
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    GemmOnly          0.000008  0.000000  0.000006        0.000006   0.000006         0.000006          0.000000   0.000006
    GemmAdd           0.000006  0.000006  0.000000        0.000000   0.000000         0.000000          0.000006   0.000004
    FusedMatMulAdd    0.000006  0.000006  0.000000        0.000000   0.000000         0.000000          0.000006   0.000004
    MatMulAdd         0.000006  0.000006  0.000000        0.000000   0.000000         0.000000          0.000006   0.000004
    CastGemmAddCast   0.000006  0.000006  0.000000        0.000000   0.000000         0.000000          0.000006   0.000004
    CastGemmOnlyCast  0.000008  0.000000  0.000006        0.000006   0.000006         0.000006          0.000000   0.000006
    ...
    ------ has_cast=True, dtype=torch.float16, device='cpu', max(b)=16.0
                      F.linear  GemmOnly   GemmAdd  FusedMatMulAdd  MatMulAdd  CastGemmAddCast  CastGemmOnlyCast  a @ x + b
    F.linear          0.000000  0.015625  0.007812        0.007812   0.007812         0.007812          0.015625   0.015625
    GemmOnly          0.015625  0.000000  0.015625        0.015625   0.015625         0.015625          0.000000   0.015625
    GemmAdd           0.007812  0.015625  0.000000        0.000000   0.000000         0.000000          0.015625   0.015625
    FusedMatMulAdd    0.007812  0.015625  0.000000        0.000000   0.000000         0.000000          0.015625   0.015625
    MatMulAdd         0.007812  0.015625  0.000000        0.000000   0.000000         0.000000          0.015625   0.015625
    CastGemmAddCast   0.007812  0.015625  0.000000        0.000000   0.000000         0.000000          0.015625   0.015625
    ...
    ------ has_cast=True, dtype=torch.float32, device='cuda', max(b)=16.0
                      F.linear  GemmOnly   GemmAdd  FusedMatMulAdd  MatMulAdd  CastGemmAddCast  CastGemmOnlyCast  a @ x + b
    F.linear          0.000000  0.002502  0.002502        0.002502   0.002502         0.002502          0.002502   0.000006
    GemmOnly          0.002502  0.000000  0.000000        0.000000   0.000000         0.000000          0.000000   0.002503
    GemmAdd           0.002502  0.000000  0.000000        0.000000   0.000000         0.000000          0.000000   0.002503
    FusedMatMulAdd    0.002502  0.000000  0.000000        0.000000   0.000000         0.000000          0.000000   0.002503
    MatMulAdd         0.002502  0.000000  0.000000        0.000000   0.000000         0.000000          0.000000   0.002503
    CastGemmAddCast   0.002502  0.000000  0.000000        0.000000   0.000000         0.000000          0.000000   0.002503
    CastGemmOnlyCast  0.002502  0.000000  0.000000        0.000000   0.000000         0.000000          0.000000   0.002503
    a @ x + b         0.000006  0.002503  0.002503        0.002503   0.002503         0.002503          0.002503   0.000000
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    labels=('F.linear', 'GemmOnly'), cuda/torch.float32: max(diff)=0.002501964569091797
...
.. image-sg:: /auto_technical/images/sphx_glr_plot_gemm_or_matmul_add_002.png
   :alt: Left column: discrepancies a @ x + b VS GemmOnly Right column: max absolute error, across all configuration white is good, orange is not, a @ x + b-GemmOnly cpu/torch.float32, max=5.7e-06, a @ x + b-GemmOnly cpu/torch.float16, max=0.016, a @ x + b-GemmOnly cuda/torch.float32, max=0.0025, a @ x + b-GemmOnly cuda/torch.float16, max=0.016, a @ x + b-GemmOnly cuda/torch.bfloat16, max=0.12
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    labels=('a @ x + b', 'GemmOnly'), cuda/torch.float32: max(diff)=0.002502918243408203
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 21.008 seconds)
