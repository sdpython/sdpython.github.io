...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +C one: float32:(1,):[1.0]
     +I X: float32:(3, 4):0.9096384048461914,0.03946341946721077,0.4959883689880371,0.6703549027442932,0.2508409321308136...
     +I Y: float32:(3, 4):0.0738883689045906,0.7186186909675598,0.7359412908554077,0.3129687011241913,0.8518691658973694...
    Mul(X, Y) -> xy
     + xy: float32:(3, 4):0.06721169501543045,0.028359150514006615,0.3650183081626892,0.2098001092672348,0.21368364989757538...
    Sigmoid(xy) -> sy
     + sy: float32:(3, 4):0.5167965888977051,0.5070893168449402,0.5902546644210815,0.5522584915161133,0.5532185435295105...
    Add(sy, one) -> C
     + C: float32:(3, 4):1.516796588897705,1.507089376449585,1.5902546644210815,1.5522584915161133,1.5532186031341553...
    Cast(C) -> X999
