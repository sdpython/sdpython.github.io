...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensor([[1.6545]], grad_fn=<MulBackward0>)
 ...
 .. code-block:: none
    ...
    def forward(self, arg0_1: "f32[2, 3]", arg1_1: "f32[2]", arg2_1: "f32[1, 2]", arg3_1: "f32[1]", arg4_1: "f32[1, 3]"):
        ...
        linear_1: "f32[1, 1]" = torch.ops.aten.linear.default(linear, arg2_1, arg3_1);  linear = arg2_1 = arg3_1 = None
         ...
         # File: /home/xadupre/github/onnx-diagnostic/_doc/recipes/plot_export_cond.py:26 in forward, code: if x.sum():
    ...
    The following call raised this error:
      File "/home/xadupre/github/onnx-diagnostic/_doc/recipes/plot_export_cond.py", line 26, in forward
        if x.sum():
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/xadupre/vv/this312/lib/python3.12/site-packages/torch/__init__.py:2636: UserWarning: You are calling torch.compile inside torch.export region. To capture an useful graph, we will implicitly switch to torch.compile(backend=eager)
      warnings.warn(
    graph():
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [transform_method] -- source -- <function ForwardWithControlFlowTest.forward at 0x77259671afc0>
