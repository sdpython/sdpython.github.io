...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +I X: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.078125,0.9921875,0.1796875,0.3515625,0.921875,0.69140625,0.6015625,0.37109375,0.125,0.01171875...
     +I Y: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.140625,0.375,0.98828125,0.3359375,0.4375,0.45703125,0.19921875,0.25,0.16015625,0.70703125...
    Mul(X, Y) -> xy
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +C one: A:bfloat16:(1,):[1.0]
     +I X: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.70703125,0.4375,0.21875,0.453125,0.21875,0.9296875,0.0390625,0.23046875,0.609375,0.23828125...
     +I Y: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.72265625,0.76953125,0.515625,0.22265625,0.8203125,0.6171875,0.88671875,0.65234375,0.046875,0.74609375...
    Mul(X, Y) -> xy
     + xy: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.51171875,0.3359375,0.11279296875,0.10107421875,0.1796875,0.57421875,0.03466796875,0.150390625,0.028564453125,0.177734375...
     - deletes: X - torch.bfloat16:torch.Size([3, 4])
    Sigmoid(xy) -> sy
     + sy: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.62890625,0.58203125,0.52734375,0.5234375,0.54296875,0.640625,0.5078125,0.5390625,0.5078125,0.54296875...
     - deletes: xy - torch.bfloat16:torch.Size([3, 4])
    Add(sy, one) -> C
     + C: A:bfloat16:(3, 4):1.625,1.578125,1.53125,1.5234375,1.546875,1.640625,1.5078125,1.5390625,1.5078125,1.546875...
