...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [get_untrained_model_with_inputs] use fct=<function get_inputs at 0x7f2f3edc3560>
    model size: 410532864
    number of weights: 102633216
    fields: {'model', 'task', 'model_kwargs', 'n_weights', 'inputs', 'dynamic_shapes', 'input_kwargs', 'size', 'configuration'}
