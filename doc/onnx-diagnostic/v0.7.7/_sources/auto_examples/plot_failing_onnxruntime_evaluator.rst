...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +I X: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.39453125,0.1953125,0.22265625,0.796875,0.48828125,0.56640625,0.703125,0.27734375,0.45703125,0.68359375...
     +I Y: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.18359375,0.39453125,0.48828125,0.32421875,0.99609375,0.0390625,0.515625,0.92578125,0.81640625,0.08984375...
    Mul(X, Y) -> xy
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +C one: A:bfloat16:(1,):[1.0]
     +I X: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.70703125,0.11328125,0.08984375,0.1875,0.50390625,0.0234375,0.90625,0.81640625,0.4375,0.7421875...
     +I Y: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.17578125,0.98046875,0.90625,0.10546875,0.74609375,0.48046875,0.3515625,0.1171875,0.33984375,0.60546875...
    Mul(X, Y) -> xy
     + xy: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.12451171875,0.11083984375,0.08154296875,0.019775390625,0.375,0.01123046875,0.318359375,0.095703125,0.1484375,0.44921875...
     - deletes: X - torch.bfloat16:torch.Size([3, 4])
    Sigmoid(xy) -> sy
     + sy: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.53125,0.52734375,0.51953125,0.50390625,0.59375,0.50390625,0.578125,0.5234375,0.5390625,0.609375...
     - deletes: xy - torch.bfloat16:torch.Size([3, 4])
    Add(sy, one) -> C
     + C: A:bfloat16:(3, 4):1.53125,1.53125,1.515625,1.5,1.59375,1.5,1.578125,1.5234375,1.5390625,1.609375...
