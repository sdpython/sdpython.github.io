    ...
    ExportedProgram:
        class GraphModule(torch.nn.Module):
            def forward(self, x: "i64[s77, s27]", y: "i64[s17, s94]", fact: "i64[1, Max(s27, s94)]"):
                ...
                sym_size_int_14: "Sym(Max(s27, s94))" = torch.ops.aten.sym_size.int(fact, 1)
                sym_max_2: "Sym(Max(s27, s94))" = torch.sym_max(sym_size_int_11, sym_size_int_13)
                eq_4: "Sym(True)" = sym_max_2 == sym_size_int_14;  sym_size_int_14 = None
                _assert_scalar_default = torch.ops.aten._assert_scalar.default(eq_4, "Runtime assertion failed for expression Eq(Max(s27, s94), s81) on node 'eq_4'");  eq_4 = _assert_scalar_default = None
                ...
                zeros: "i64[Max(s17, s77), Max(s27, s94)]" = torch.ops.aten.zeros.default([sym_max, sym_max_2], dtype = torch.int64, device = device(type='cpu'), pin_memory = False);  sym_max = sym_max_2 = None
