...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +I X: D-1:torch.bfloat16:torch.Size([3, 4]):0.375,0.48046875,0.6015625,0.171875,0.37109375,0.71875,0.296875,0.8828125,0.99609375,0.97265625...
     +I Y: D-1:torch.bfloat16:torch.Size([3, 4]):0.640625,0.98828125,0.72265625,0.80859375,0.44140625,0.96875,0.25390625,0.82421875,0.99609375,0.67578125...
    Mul(X, Y) -> xy
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +C one: bfloat16:(1,):[1.0]
     +I X: D-1:torch.bfloat16:torch.Size([3, 4]):0.68359375,0.91796875,0.046875,0.875,0.90625,0.12890625,0.75,0.36328125,0.234375,0.6328125...
     +I Y: D-1:torch.bfloat16:torch.Size([3, 4]):0.21875,0.41015625,0.140625,0.76953125,0.5625,0.94921875,0.4765625,0.875,0.76953125,0.0390625...
    Mul(X, Y) -> xy
     + xy: D-1:torch.bfloat16:torch.Size([3, 4]):0.1494140625,0.376953125,0.006591796875,0.671875,0.5078125,0.12255859375,0.357421875,0.318359375,0.1806640625,0.024658203125...
    Sigmoid(xy) -> sy
     + sy: D-1:torch.bfloat16:torch.Size([3, 4]):0.5390625,0.59375,0.50390625,0.66015625,0.625,0.53125,0.5859375,0.578125,0.54296875,0.5078125...
    Add(sy, one) -> C
     + C: bfloat16:(3, 4):1.5390625,1.59375,1.5,1.65625,1.625,1.53125,1.5859375,1.578125,1.546875,1.5078125...
    Cast(C) -> X999
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 10.023 seconds)
