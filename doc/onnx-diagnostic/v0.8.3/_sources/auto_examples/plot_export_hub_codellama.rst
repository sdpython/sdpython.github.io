...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [get_untrained_model_with_inputs] -- done(2) in 1.3729997590417042e-05s
    ...
    [get_untrained_model_with_inputs] -- done(3) in 3.341800038469955e-05s (model is <class 'NoneType'>)
    ...
    [get_untrained_model_with_inputs] -- done(4) in 6.094417568998324s (model is <class 'transformers.models.llama.modeling_llama.LlamaForCausalLM'>)
    [get_untrained_model_with_inputs] use fct=<function get_inputs at 0x771aee262340>
    model size: 2667659264
    number of weights: 666914816
    fields: {'task', 'inputs_empty_cache', 'model_kwargs', 'input_kwargs', 'inputs_batch1', 'size', 'inputs', 'dump_info', 'n_weights', 'inputs2', 'configuration', 'inputs_prompt', 'dynamic_shapes', 'model'}
    ...
    ExportedProgram:
        class GraphModule(torch.nn.Module):
            def forward(self, p_model_embed_tokens_weight: "f32[32000, 4096]", p_model_layers_0_self_attn_q_proj_weight: "f32[4096, 4096]", p_model_layers_0_self_attn_k_proj_weight: "f32[4096, 4096]", p_model_layers_0_self_attn_v_proj_weight: "f32[4096, 4096]", p_model_layers_0_self_attn_o_proj_weight: "f32[4096, 4096]", p_model_layers_0_mlp_gate_proj_weight: "f32[11008, 4096]", p_model_layers_0_mlp_up_proj_weight: "f32[11008, 4096]", p_model_layers_0_mlp_down_proj_weight: "f32[4096, 11008]", p_model_layers_0_input_layernorm_weight: "f32[4096]", p_model_layers_0_post_attention_layernorm_weight: "f32[4096]", p_model_layers_1_self_attn_q_proj_weight: "f32[4096, 4096]", p_model_layers_1_self_attn_k_proj_weight: "f32[4096, 4096]", p_model_layers_1_self_attn_v_proj_weight: "f32[4096, 4096]", p_model_layers_1_self_attn_o_proj_weight: "f32[4096, 4096]", p_model_layers_1_mlp_gate_proj_weight: "f32[11008, 4096]", p_model_layers_1_mlp_up_proj_weight: "f32[11008, 4096]", p_model_layers_1_mlp_down_proj_weight: "f32[4096, 11008]", p_model_layers_1_input_layernorm_weight: "f32[4096]", p_model_layers_1_post_attention_layernorm_weight: "f32[4096]", p_model_norm_weight: "f32[4096]", p_lm_head_weight: "f32[32000, 4096]", b_model_rotary_emb_inv_freq: "f32[64]", input_ids: "i64[s44, s70]", attention_mask: "i64[s43, s53]", position_ids: "i64[s44, s70]", past_key_values_key_0: "f32[s44, 32, s45, 128]", past_key_values_value_0: "f32[s44, 32, s21, 128]", past_key_values_key_1: "f32[s44, 32, s14, 128]", past_key_values_value_1: "f32[s44, 32, s50, 128]"):
                ...
                add: "Sym(s45 + s70)" = sym_size_int_28 + sym_size_int_22
                ...
                arange: "i64[s70]" = torch.ops.aten.arange.start(sym_size_int_28, add, device = device(type='cpu'), pin_memory = False);  sym_size_int_28 = None
                ...
                expand: "b8[s44, 1, s70, s45 + s70]" = torch.ops.aten.expand.default(and_2, [sym_size_int_25, -1, sym_size_int_22, add]);  and_2 = None
                ...
                slice_10: "b8[s44, 1, s70, s45 + s70]" = torch.ops.aten.slice.Tensor(expand, 3, None, add)
                ...
                # No stacktrace found for following nodes
                le_8: "Sym(s14 + s70 <= s45 + s70)" = sym_size_int_35 <= add;  add = None
