...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +C one: float32:(1,):[1.0]
     +I X: float32:(3, 4):0.21323451399803162,0.10425049811601639,0.40765684843063354,0.7347217798233032,0.35059472918510437...
     +I Y: float32:(3, 4):0.8668363690376282,0.6358137726783752,0.11167389899492264,0.8923654556274414,0.4473317265510559...
    Mul(X, Y) -> xy
     + xy: float32:(3, 4):0.1848394274711609,0.06628390401601791,0.045524630695581436,0.6556403636932373,0.15683214366436005...
    Sigmoid(xy) -> sy
     + sy: float32:(3, 4):0.5460787415504456,0.5165649056434631,0.5113791823387146,0.6582803726196289,0.5391278862953186...
    Add(sy, one) -> C
     + C: float32:(3, 4):1.5460786819458008,1.5165648460388184,1.5113792419433594,1.658280372619629,1.5391278266906738...
    Cast(C) -> X999
