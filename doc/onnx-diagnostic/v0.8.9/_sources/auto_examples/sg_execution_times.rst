...
Computation times
=================
**00:11.585** total execution time for 15 files **from auto_examples**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_auto_examples_plot_export_tiny_llm_method_generate.py` (``plot_export_tiny_llm_method_generate.py``)
     - 00:11.585
     - 0.0
