...
Computation times
=================
**00:58.849** total execution time for 35 files **from all galleries**:
...
.. container::
   ...
   * - :ref:`sphx_glr_auto_final_plot_export_tiny_llm_input_observer.py` (``final/plot_export_tiny_llm_input_observer.py``)
     - 00:00.000
     - 0.0
   * - :ref:`sphx_glr_auto_final_plot_export_tiny_llm_method_generate.py` (``final/plot_export_tiny_llm_method_generate.py``)
     - 00:00.000
     - 0.0
   * - :ref:`sphx_glr_auto_final_plot_export_whisper_tiny_input_observer.py` (``final/plot_export_whisper_tiny_input_observer.py``)
     - 00:00.000
     - 0.0
