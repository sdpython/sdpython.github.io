...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +I X: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.38671875,0.54296875,0.56640625,0.6015625,0.3359375,0.2109375,0.140625,0.375,0.125,0.14453125...
     +I Y: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.04296875,0.67578125,0.77734375,0.26953125,0.45703125,0.8671875,0.33984375,0.50390625,0.70703125,0.1015625...
    Mul(X, Y) -> xy
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +C one: A:bfloat16:(1,):[1.0]
     +I X: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.609375,0.98828125,0.38671875,0.20703125,0.51171875,0.765625,0.09765625,0.62890625,0.75,0.953125...
     +I Y: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.35546875,0.09375,0.390625,0.62890625,0.171875,0.42578125,0.859375,0.65625,0.75390625,0.46875...
    Mul(X, Y) -> xy
     + xy: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.216796875,0.0927734375,0.1513671875,0.1298828125,0.087890625,0.326171875,0.083984375,0.412109375,0.56640625,0.447265625...
     - deletes: X - torch.bfloat16:torch.Size([3, 4])
    Sigmoid(xy) -> sy
     + sy: T:D-1:torch.bfloat16:torch.Size([3, 4]):0.5546875,0.5234375,0.5390625,0.53515625,0.5234375,0.58203125,0.51953125,0.6015625,0.640625,0.609375...
     - deletes: xy - torch.bfloat16:torch.Size([3, 4])
    Add(sy, one) -> C
     + C: A:bfloat16:(3, 4):1.5546875,1.5234375,1.5390625,1.53125,1.5234375,1.578125,1.515625,1.6015625,1.640625,1.609375...
