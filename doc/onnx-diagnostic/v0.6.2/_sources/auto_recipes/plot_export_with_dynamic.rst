    ...
    ExportedProgram:
        class GraphModule(torch.nn.Module):
            def forward(self, x: "f32[s35, s16]", y: "f32[s35, s43]", z: "f32[s35, s23]"):
                 # 
                sym_size_int: "Sym(s35)" = torch.ops.aten.sym_size.int(x, 0)
                sym_size_int_1: "Sym(s16)" = torch.ops.aten.sym_size.int(x, 1)
                sym_size_int_2: "Sym(s35)" = torch.ops.aten.sym_size.int(y, 0)
                sym_size_int_3: "Sym(s43)" = torch.ops.aten.sym_size.int(y, 1)
                sym_size_int_4: "Sym(s35)" = torch.ops.aten.sym_size.int(z, 0)
                sym_size_int_5: "Sym(s23)" = torch.ops.aten.sym_size.int(z, 1)
                ...
                add_2: "Sym(s23 + 1)" = 1 + sym_size_int_5;  sym_size_int_5 = None
                floordiv: "Sym(((s23 + 1)//2))" = add_2 // 2;  add_2 = None
                eq_1: "Sym(Eq(s16 + s43, ((s23 + 1)//2)))" = add_1 == floordiv;  add_1 = floordiv = None
                _assert_scalar_default_1 = torch.ops.aten._assert_scalar.default(eq_1, "Runtime assertion failed for expression Eq(s16 + s43, ((s23 + 1)//2)) on node 'eq_1'");  eq_1 = _assert_scalar_default_1 = None
