...
.. "auto_examples/plot_exporter_exporter_dynamic_shapes_auto.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_plot_exporter_exporter_dynamic_shapes_auto.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_exporter_exporter_dynamic_shapes_auto.py:
        ...
        class GraphModule(torch.nn.Module):
            def forward(self, x: "f32[s0, s1]", y: "f32[s0, s3]", z: "f32[s0, s5]"):
                ...
                sym_size_int_5: "Sym(s5)" = torch.ops.aten.sym_size.int(z, 1)
                 ...
                 # File: /home/xadupre/github/onnx-diagnostic/_doc/examples/plot_exporter_exporter_dynamic_shapes_auto.py:17 in forward, code: return torch.cat((x, y), axis=1) + z[:, ::2]
...
.. _sphx_glr_download_auto_examples_plot_exporter_exporter_dynamic_shapes_auto.py:
