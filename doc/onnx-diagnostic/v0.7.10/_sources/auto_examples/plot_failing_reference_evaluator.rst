...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +C one: float32:(1,):[1.0]
     +I X: float32:(3, 4):0.2628096044063568,0.629470705986023,0.07218103855848312,0.8653561472892761,0.15009449422359467...
     +I Y: float32:(3, 4):0.7536391615867615,0.9416059851646423,0.110308937728405,0.28754761815071106,0.047266606241464615...
    Mul(X, Y) -> xy
     + xy: float32:(3, 4):0.19806361198425293,0.5927133560180664,0.007962213829159737,0.24883109331130981,0.007094457279890776...
    Sigmoid(xy) -> sy
     + sy: float32:(3, 4):0.5493546724319458,0.6439874768257141,0.501990556716919,0.5618887543678284,0.5017735958099365...
    Add(sy, one) -> C
     + C: float32:(3, 4):1.5493546724319458,1.6439874172210693,1.501990556716919,1.5618886947631836,1.5017735958099365...
    Cast(C) -> X999
