...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/xadupre/github/onnx-diagnostic/_doc/recipes/plot_dynamic_shapes_json.py:77: FutureWarning: `treespec.children_specs` is deprecated. Use `treespec.child(index)` to access a single child, or `treespec.children()` to get all children.
      for subspec in spec.children_specs:
    {'input_mask_position': ({'0': 'd_0_0', '1': 'd_0_1'},
                             {'0': 'd_1_0', '1': 'd_1_1'},
                             {'0': 'd_2_0'}),
