...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    -- running with torch
    -- torch: #1[CT1s2x1024x1152[243.69688415527344,338.05694580078125:A287.0196366876092]]
    -- running with ort
    -- ort: #1[A1s2x1024x1152[243.69688415527344,338.0569763183594:A287.0196366376088]]
    -- diff abs=0.000152587890625, rel=5.779064891932421e-07, n=2359296.0/#1492443>0.0-#2329>0.0001

    -- running on CPU with FLOAT16
    -- running with torch
    -- torch: #1[CT10s2x1024x1152[243.625,338.25:A287.0168085628086]]
    -- running with ort
    -- ort: #1[A10s2x1024x1152[243.75,338.0:A287.01956637700397]]
    -- diff abs=0.25, rel=0.0009765586853176355, n=2359296.0/#594490>0.0-#594490>0.0001-#594490>0.001-#594490>0.01-#594490>0.1

    -- running on CUDA with FLOAT
    -- running with torch
    -- torch: #1[GT1s32x1024x1152[237.32598876953125,338.0569763183594:A287.00301574078344]]
    -- running with ort
    -- ort: #1[A1s32x1024x1152[237.32778930664062,338.0547180175781:A287.0003584383121]]
    -- diff abs=0.020538330078125, rel=7.164276269523561e-05, n=37748736.0/#37648620>0.0-#37045977>0.0001-#31254173>0.001-#522325>0.01

    -- running on CUDA with FLOAT16
    -- running with torch
    -- torch: #1[GT10s32x1024x1152[237.375,338.25:A286.998071561257]]
    -- running with ort
    -- ort: #1[A10s32x1024x1152[237.375,338.25:A286.99807155794565]]
    -- diff abs=0.5, rel=0.001751307350937475, n=37748736.0/#1575>0.0-#1575>0.0001-#1575>0.001-#1575>0.01-#1575>0.1
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    provider dtype                                                                                                         
    CPU      FLOAT    0.000153  5.779065e-07      58.232224   2359296.0   1492443      2329         0       0       0     0
             FLOAT16  0.250000  9.765587e-04  148584.250000   2359296.0    594490    594490    594490  594490  594490     0
    CUDA     FLOAT    0.020538  7.164276e-05  130717.009567  37748736.0  37648620  37045977  31254173  522325       0     0
             FLOAT16  0.500000  1.751307e-03     393.875000  37748736.0      1575      1575      1575    1575    1575     0
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    -- ORT-ORT: #1[CT1s2x1024x1152[243.69688415527344,338.0569763183594:A287.0196366376088]]
    -- diff with torch abs=0.000152587890625, rel=5.779064891932421e-07, n=2359296.0
    -- diff with ort abs=0, rel=0

    -- ORT-ORT running on CPU with FLOAT16
    -- ORT-ORT: #1[CT10s2x1024x1152[243.625,338.25:A287.01680994033813]]
    -- diff with torch abs=0.25, rel=0.0009737060420407322, n=2359296.0
    -- diff with ort abs=0.25, rel=0.0009765586853176355, n=2359296.0

    -- ORT-ORT running on CUDA with FLOAT
    -- ORT-ORT: #1[GT1s32x1024x1152[237.32778930664062,338.0547180175781:A287.0003584383121]]
    -- diff with torch abs=0.020538330078125, rel=7.164276269523561e-05, n=37748736.0
    -- diff with ort abs=0, rel=0

    -- ORT-ORT running on CUDA with FLOAT16
    -- ORT-ORT: #1[GT10s32x1024x1152[237.375,338.25:A286.99807155794565]]
    -- diff with torch abs=0.5, rel=0.001751307350937475, n=37748736.0
    -- diff with ort abs=0, rel=0

    -- ORT-TORCH running on CPU with FLOAT
    -- ORT-TORCH: #1[CT1s2x1024x1152[243.69688415527344,338.05694580078125:A287.01963664035105]]
    -- diff with torch abs=0.0001220703125, rel=4.4806070415315114e-07, n=2359296.0
    -- diff with ort abs=0.000152587890625, rel=5.517310924519893e-07, n=2359296.0

    -- ORT-TORCH running on CPU with FLOAT16
    -- ORT-TORCH: #1[CT10s2x1024x1152[243.625,338.25:A287.016807185279]]
    -- diff with torch abs=0.25, rel=0.0009737060420407322, n=2359296.0
    -- diff with ort abs=0.25, rel=0.0009765586853176355, n=2359296.0

    -- ORT-TORCH running on CUDA with FLOAT
    -- ORT-TORCH: #1[GT1s32x1024x1152[237.32598876953125,338.0569763183594:A287.00301573532164]]
    -- diff with torch abs=0.000152587890625, rel=5.2906051264291e-07, n=37748736.0
    -- diff with ort abs=0.0205078125, rel=7.164789574842833e-05, n=37748736.0

    -- ORT-TORCH running on CUDA with FLOAT16
    -- ORT-TORCH: #1[GT10s32x1024x1152[237.375,338.25:A286.99807155794565]]
    -- diff with torch abs=0.5, rel=0.001751307350937475, n=37748736.0
    -- diff with ort abs=0, rel=0

    -- TORCH-ORT running on CPU with FLOAT
    -- TORCH-ORT: #1[CT1s2x1024x1152[243.69688415527344,338.0569763183594:A287.01963668674904]]
    -- diff with torch abs=0.000152587890625, rel=5.51730788044959e-07, n=2359296.0
    -- diff with ort abs=0.0001220703125, rel=4.225445800926728e-07, n=2359296.0

    -- TORCH-ORT running on CPU with FLOAT16
    -- TORCH-ORT: #1[CT10s2x1024x1152[243.625,338.25:A287.0168083508809]]
    -- diff with torch abs=0.25, rel=0.0009532852114958571, n=2359296.0
    -- diff with ort abs=0.25, rel=0.0009765586853176355, n=2359296.0

    -- TORCH-ORT running on CUDA with FLOAT
    -- TORCH-ORT: #1[GT1s32x1024x1152[237.32778930664062,338.0547180175781:A287.0003586507341]]
    -- diff with torch abs=0.020538330078125, rel=7.164276269523561e-05, n=37748736.0
    -- diff with ort abs=0.001953125, rel=7.290071207055391e-06, n=37748736.0

    -- TORCH-ORT running on CUDA with FLOAT16
    -- TORCH-ORT: #1[GT10s32x1024x1152[237.375,338.25:A286.998071561257]]
    -- diff with torch abs=0, rel=0
    -- diff with ort abs=0.5, rel=0.001751307350937475, n=37748736.0

    -- TORCH-TORCH running on CPU with FLOAT
    -- TORCH-TORCH: #1[CT1s2x1024x1152[243.69688415527344,338.05694580078125:A287.0196366876092]]
    -- diff with torch abs=0, rel=0
    -- diff with ort abs=0.000152587890625, rel=5.779061552175248e-07, n=2359296.0

    -- TORCH-TORCH running on CPU with FLOAT16
    -- TORCH-TORCH: #1[CT10s2x1024x1152[243.625,338.25:A287.0168085628086]]
    -- diff with torch abs=0, rel=0
    -- diff with ort abs=0.25, rel=0.0009765586853176355, n=2359296.0

    -- TORCH-TORCH running on CUDA with FLOAT
    -- TORCH-TORCH: #1[GT1s32x1024x1152[237.32598876953125,338.0569763183594:A287.00301574078344]]
    -- diff with torch abs=0, rel=0
    -- diff with ort abs=0.020538330078125, rel=7.164789574842833e-05, n=37748736.0

    -- TORCH-TORCH running on CUDA with FLOAT16
    -- TORCH-TORCH: #1[GT10s32x1024x1152[237.375,338.25:A286.998071561257]]
    -- diff with torch abs=0, rel=0
    -- diff with ort abs=0.5, rel=0.001751307350937475, n=37748736.0
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    FLOAT   CPU      ORT-ORT      0.000000    0.000153
            ...
            CUDA     ORT-ORT      0.000000    0.020538
                     ORT-TORCH    0.020508    0.000153
                     TORCH-ORT    0.001953    0.020538
                     TORCH-TORCH  0.020538    0.000000
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 48.986 seconds)
