...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +I X: D-1:torch.bfloat16:torch.Size([3, 4]):0.57421875,0.44921875,0.1796875,0.42578125,0.3359375,0.046875,0.3828125,0.26171875,0.62109375,0.578125...
     +I Y: D-1:torch.bfloat16:torch.Size([3, 4]):0.07421875,0.96484375,0.28125,0.9140625,0.29296875,0.171875,0.40625,0.5078125,0.87109375,0.515625...
    Mul(X, Y) -> xy
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
     ...
     +C one: bfloat16:(1,):[1.0]
     +I X: D-1:torch.bfloat16:torch.Size([3, 4]):0.7265625,0.56640625,0.5703125,0.75,0.56640625,0.4765625,0.13671875,0.390625,0.01171875,0.4765625...
     +I Y: D-1:torch.bfloat16:torch.Size([3, 4]):0.6640625,0.375,0.6875,0.9140625,0.375,0.8125,0.859375,0.84765625,0.19921875,0.76953125...
    Mul(X, Y) -> xy
     + xy: D-1:torch.bfloat16:torch.Size([3, 4]):0.482421875,0.212890625,0.392578125,0.6875,0.212890625,0.38671875,0.11767578125,0.33203125,0.0023345947265625,0.3671875...
    Sigmoid(xy) -> sy
     + sy: D-1:torch.bfloat16:torch.Size([3, 4]):0.6171875,0.55078125,0.59765625,0.66796875,0.55078125,0.59375,0.52734375,0.58203125,0.5,0.59375...
    Add(sy, one) -> C
     + C: bfloat16:(3, 4):1.6171875,1.546875,1.59375,1.671875,1.546875,1.59375,1.53125,1.578125,1.5,1.59375...
    Cast(C) -> X999
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 12.018 seconds)
