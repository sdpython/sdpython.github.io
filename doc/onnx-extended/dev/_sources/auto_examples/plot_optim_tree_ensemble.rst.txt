...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    TreeEnsembleRegressor(X, n_targets=1, nodes_falsenodeids=630:[32,17,10...62,0,0], nodes_featureids=630:[1,2,4...2,0,0], nodes_hitrates=630:[1.0,1.0...1.0,1.0], nodes_missing_value_tracks_true=630:[0,0,0...0,0,0], nodes_modes=630:[b'BRANCH_LEQ',b'BRANCH_LEQ'...b'LEAF',b'LEAF'], nodes_nodeids=630:[0,1,2...60,61,62], nodes_treeids=630:[0,0,0...9,9,9], nodes_truenodeids=630:[1,2,3...61,0,0], nodes_values=630:[0.02700837329030037,0.00756989186629653...0.0,0.0], post_transform=b'NONE', target_ids=320:[0,0,0...0,0,0], target_nodeids=320:[5,6,8...59,61,62], target_treeids=320:[0,0,0...9,9,9], target_weights=320:[-34.94485092163086,-25.160097122192383...26.543302536010742,35.054134368896484]) -> variable
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    input: name='X' type=dtype('float32') shape=['', 5]
    TreeEnsembleRegressor[onnx_extented.ortops.optim.cpu](X, nodes_modes=b'BRANCH_LEQ,BRANCH_LEQ,BRANCH_LEQ,BRANC...LEAF,LEAF', n_targets=1, nodes_falsenodeids=630:[32,17,10...62,0,0], nodes_featureids=630:[1,2,4...2,0,0], nodes_hitrates=630:[1.0,1.0...1.0,1.0], nodes_missing_value_tracks_true=630:[0,0,0...0,0,0], nodes_nodeids=630:[0,1,2...60,61,62], nodes_treeids=630:[0,0,0...9,9,9], nodes_truenodeids=630:[1,2,3...61,0,0], nodes_values=630:[0.02700837329030037,0.00756989186629653...0.0,0.0], post_transform=b'NONE', target_ids=320:[0,0,0...0,0,0], target_nodeids=320:[5,6,8...59,61,62], target_treeids=320:[0,0,0...9,9,9], target_weights=320:[-34.94485092163086,-25.160097122192383...26.543302536010742,35.054134368896484]) -> variable
    output: name='variable' type=dtype('float32') shape=['', 1]
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    CReferenceEvaluator: 0.3281312000035541
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    ReferenceEvaluator: 5.945850199997949 (only 5 times instead of 50)
...
      0%|          | 0/16 [00:00<?, ?it/s]    i=1/16 TRY=0 parallel_tree=80 parallel_tree_N=128 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:   0%|          | 0/16 [00:00<?, ?it/s]    i=1/16 TRY=0 parallel_tree=80 parallel_tree_N=128 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:   6%|6         | 1/16 [00:00<00:09,  1.52it/s]    i=2/16 TRY=0 parallel_tree=80 parallel_tree_N=128 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:   6%|6         | 1/16 [00:00<00:09,  1.52it/s]    i=2/16 TRY=0 parallel_tree=80 parallel_tree_N=128 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  12%|#2        | 2/16 [00:00<00:06,  2.14it/s]    i=3/16 TRY=0 parallel_tree=80 parallel_tree_N=64 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  12%|#2        | 2/16 [00:00<00:06,  2.14it/s]     i=3/16 TRY=0 parallel_tree=80 parallel_tree_N=64 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  19%|#8        | 3/16 [00:01<00:05,  2.48it/s]    i=4/16 TRY=0 parallel_tree=80 parallel_tree_N=64 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  19%|#8        | 3/16 [00:01<00:05,  2.48it/s]    i=4/16 TRY=0 parallel_tree=80 parallel_tree_N=64 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  25%|##5       | 4/16 [00:01<00:04,  2.80it/s]    i=5/16 TRY=0 parallel_tree=40 parallel_tree_N=128 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  25%|##5       | 4/16 [00:01<00:04,  2.80it/s]    i=5/16 TRY=0 parallel_tree=40 parallel_tree_N=128 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  31%|###1      | 5/16 [00:01<00:03,  3.08it/s]    i=6/16 TRY=0 parallel_tree=40 parallel_tree_N=128 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  31%|###1      | 5/16 [00:01<00:03,  3.08it/s]    i=6/16 TRY=0 parallel_tree=40 parallel_tree_N=128 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  38%|###7      | 6/16 [00:02<00:03,  3.31it/s]    i=7/16 TRY=0 parallel_tree=40 parallel_tree_N=64 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  38%|###7      | 6/16 [00:02<00:03,  3.31it/s]     i=7/16 TRY=0 parallel_tree=40 parallel_tree_N=64 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  44%|####3     | 7/16 [00:02<00:02,  3.47it/s]    i=8/16 TRY=0 parallel_tree=40 parallel_tree_N=64 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  44%|####3     | 7/16 [00:02<00:02,  3.47it/s]    i=8/16 TRY=0 parallel_tree=40 parallel_tree_N=64 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  50%|#####     | 8/16 [00:02<00:02,  3.58it/s]    i=9/16 TRY=1 parallel_tree=80 parallel_tree_N=128 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  50%|#####     | 8/16 [00:02<00:02,  3.58it/s]    i=9/16 TRY=1 parallel_tree=80 parallel_tree_N=128 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  56%|#####6    | 9/16 [00:02<00:01,  3.72it/s]    i=10/16 TRY=1 parallel_tree=80 parallel_tree_N=128 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  56%|#####6    | 9/16 [00:02<00:01,  3.72it/s]    i=10/16 TRY=1 parallel_tree=80 parallel_tree_N=128 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  62%|######2   | 10/16 [00:03<00:01,  3.79it/s]    i=11/16 TRY=1 parallel_tree=80 parallel_tree_N=64 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  62%|######2   | 10/16 [00:03<00:01,  3.79it/s]     i=11/16 TRY=1 parallel_tree=80 parallel_tree_N=64 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  69%|######8   | 11/16 [00:03<00:01,  3.85it/s]    i=12/16 TRY=1 parallel_tree=80 parallel_tree_N=64 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  69%|######8   | 11/16 [00:03<00:01,  3.85it/s]    i=12/16 TRY=1 parallel_tree=80 parallel_tree_N=64 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  75%|#######5  | 12/16 [00:03<00:01,  3.89it/s]    i=13/16 TRY=1 parallel_tree=40 parallel_tree_N=128 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  75%|#######5  | 12/16 [00:03<00:01,  3.89it/s]    i=13/16 TRY=1 parallel_tree=40 parallel_tree_N=128 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  81%|########1 | 13/16 [00:03<00:00,  3.79it/s]    i=14/16 TRY=1 parallel_tree=40 parallel_tree_N=128 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  81%|########1 | 13/16 [00:03<00:00,  3.79it/s]    i=14/16 TRY=1 parallel_tree=40 parallel_tree_N=128 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  88%|########7 | 14/16 [00:04<00:00,  3.79it/s]    i=15/16 TRY=1 parallel_tree=40 parallel_tree_N=64 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  88%|########7 | 14/16 [00:04<00:00,  3.79it/s]     i=15/16 TRY=1 parallel_tree=40 parallel_tree_N=64 parallel_N=50 batch_size_tree=2 batch_size_rows=2 use_node3=0:  94%|#########3| 15/16 [00:04<00:00,  3.86it/s]    i=16/16 TRY=1 parallel_tree=40 parallel_tree_N=64 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0:  94%|#########3| 15/16 [00:04<00:00,  3.86it/s]    i=16/16 TRY=1 parallel_tree=40 parallel_tree_N=64 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0: 100%|##########| 16/16 [00:04<00:00,  3.89it/s]    i=16/16 TRY=1 parallel_tree=40 parallel_tree_N=64 parallel_N=25 batch_size_tree=2 batch_size_rows=2 use_node3=0: 100%|##########| 16/16 [00:04<00:00,  3.41it/s]
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    0  0.002671   0.000374  0.002131  0.003377      10      10  ...            NaN              NaN         NaN              NaN             NaN       NaN
    1  0.001580   0.000168  0.001351  0.001842      10      10  ...           80.0            128.0        50.0              2.0             2.0       0.0
    2  0.002192   0.000650  0.001478  0.003853      10      10  ...           80.0            128.0        25.0              2.0             2.0       0.0
    3  0.002092   0.000649  0.001538  0.003872      10      10  ...           80.0             64.0        50.0              2.0             2.0       0.0
    4  0.001674   0.000094  0.001558  0.001873      10      10  ...           80.0             64.0        25.0              2.0             2.0       0.0
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    9   0.001337   0.000063  0.013372     0.006790      8  ...           128.0        50.0              2.0              2.0        0.0
    15  0.001353   0.000057  0.013528     0.007338     14  ...            64.0        50.0              2.0              2.0        0.0
    11  0.001369   0.000057  0.013689     0.006611     10  ...            64.0        50.0              2.0              2.0        0.0
    12  0.001387   0.000085  0.013871     0.006781     11  ...            64.0        25.0              2.0              2.0        0.0
    10  0.001392   0.000081  0.013924     0.007332      9  ...           128.0        25.0              2.0              2.0        0.0
    16  0.001397   0.000115  0.013972     0.006876     15  ...            64.0        25.0              2.0              2.0        0.0
    6   0.001439   0.000075  0.014392     0.007060      5  ...           128.0        25.0              2.0              2.0        0.0
    7   0.001457   0.000126  0.014572     0.008024      6  ...            64.0        50.0              2.0              2.0        0.0
    14  0.001468   0.000086  0.014685     0.007114     13  ...           128.0        25.0              2.0              2.0        0.0
    8   0.001469   0.000220  0.014691     0.007775      7  ...            64.0        25.0              2.0              2.0        0.0
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    14  0.001468   0.000086  0.014685     0.007114     13  ...           128.0        25.0              2.0              2.0        0.0
    8   0.001469   0.000220  0.014691     0.007775      7  ...            64.0        25.0              2.0              2.0        0.0
    5   0.001509   0.000051  0.015091     0.007480      4  ...           128.0        50.0              2.0              2.0        0.0
    1   0.001580   0.000168  0.015800     0.008029      0  ...           128.0        50.0              2.0              2.0        0.0
    13  0.001635   0.000293  0.016347     0.008884     12  ...           128.0        50.0              2.0              2.0        0.0
    4   0.001674   0.000094  0.016744     0.007909      3  ...            64.0        25.0              2.0              2.0        0.0
    3   0.002092   0.000649  0.020924     0.009602      2  ...            64.0        50.0              2.0              2.0        0.0
    2   0.002192   0.000650  0.021919     0.009555      1  ...           128.0        25.0              2.0              2.0        0.0
    0   0.002671   0.000374  0.026709     0.012021      0  ...             NaN         NaN              NaN              NaN        NaN
    17  0.003671   0.000374  0.036706     0.015854      0  ...             NaN         NaN              NaN              NaN        NaN
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  16.153 seconds)
