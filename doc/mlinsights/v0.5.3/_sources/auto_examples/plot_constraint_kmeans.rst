...
.. image-sg:: /auto_examples/images/sphx_glr_plot_constraint_kmeans_002.png
   :alt: KMeans 4 clusters Counter({np.int32(0): 50, np.int32(2): 50, np.int32(1): 27, np.int32(3): 23})
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.legend.Legend object at 0x79fb82be1b80>
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_constraint_kmeans_003.png
   :alt: ConstraintKMeans 4 clusters (gains) Counter({np.int32(2): 39, np.int32(0): 37, np.int32(3): 37, np.int32(1): 37}), ConstraintKMeans 4 clusters (distances) Counter({np.int32(2): 38, np.int32(0): 38, np.int32(3): 37, np.int32(1): 37})
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.legend.Legend object at 0x79fba0e82330>
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_constraint_kmeans_004.png
   :alt: ConstraintKMeans 4 clusters strategy='weights' Counter({np.int32(1): 49, np.int32(0): 49, np.int32(2): 48, np.int32(3): 4}), Centers movement
