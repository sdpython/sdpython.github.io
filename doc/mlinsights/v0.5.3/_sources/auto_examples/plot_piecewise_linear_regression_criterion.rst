...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    array([5.74244772, 0.01336428, 2.93571558, 0.01336428, 5.74244772])
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.legend.Legend object at 0x79fb83115a60>
...
.. raw:: html
    ...
    */
    ...
    .copy-paste-icon {
        ...
        cursor: pointer;
    ...
    </style><body><div id="sk-container-id-22" class="sk-top-container"><div class="sk-text-repr-fallback"><pre>DecisionTreeRegressor(criterion=&lt;mlinsights.mlmodel.piecewise_tree_regression_criterion.SimpleRegressorCriterion object at 0x11848620&gt;,
            ...
            <tr class="user-set">
                ...
                ></i></td>
                <td class="param">criterion&nbsp;</td>
                <td class="value">&lt;mlinsights.m...at 0x11848620&gt;</td>
            </tr>
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    array([ 5.37570616, -0.01767352,  2.93571558,  1.29344132,  5.37570616])
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.legend.Legend object at 0x79fb82d40290>
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    {'average': np.float64(0.0006190558820017031), 'deviation': np.float64(1.9371552764484746e-05), 'min_exec': np.float64(0.000589290380012244), 'max_exec': np.float64(0.0006484994199854555), 'repeat': 10, 'number': 50, 'ttime': np.float64(0.006190558820017031), 'context_size': 832, 'warmup_time': 0.0010688660004234407}
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    {'average': np.float64(0.003021039250001195), 'deviation': np.float64(0.00012591410127951716), 'min_exec': np.float64(0.002883172479996574), 'max_exec': np.float64(0.003226429400019697), 'repeat': 10, 'number': 50, 'ttime': np.float64(0.03021039250001195), 'context_size': 832, 'warmup_time': 0.0032488639990333468}
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.legend.Legend object at 0x79fb82be3b30>
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    {'average': np.float64(0.0006902435220035841), 'deviation': np.float64(0.00019936838711371959), 'min_exec': np.float64(0.0005707326200354146), 'max_exec': np.float64(0.0011476778399810428), 'repeat': 10, 'number': 50, 'ttime': np.float64(0.006902435220035841), 'context_size': 832, 'warmup_time': 0.001947063999978127}
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    {'average': np.float64(0.0016636250820010897), 'deviation': np.float64(0.00013498323858237364), 'min_exec': np.float64(0.0015377889200317442), 'max_exec': np.float64(0.0020270659999368943), 'repeat': 10, 'number': 50, 'ttime': np.float64(0.016636250820010898), 'context_size': 832, 'warmup_time': 0.0016026170014811214}
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    {'average': np.float64(0.001851180502009811), 'deviation': np.float64(0.00045638533539121644), 'min_exec': np.float64(0.0015845426600571955), 'max_exec': np.float64(0.0031987589199707145), 'repeat': 10, 'number': 50, 'ttime': np.float64(0.01851180502009811), 'context_size': 832, 'warmup_time': 0.0016628860030323267}
