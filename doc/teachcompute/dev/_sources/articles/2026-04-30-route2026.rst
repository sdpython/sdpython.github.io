...
Séance 4 - 22/04: mémoire et C++
++++++++++++++++++++++++++++++++

* notion de cache line (64 octets cache miss, flase sharing)
* Translation Lookaside Buffer (TLB,), TLB miss
* mémoire alignée (posix_memalign)
* option de compilation

* notions C/C++
* STL
* OpenMP
* écriture de threads sans OpenMP
* interfaçage avec cython, nanobind
